...
public class TroughItemRenderer extends ItemStackTileEntityRenderer
{
    public static final TroughItemRenderer instance = new TroughItemRenderer();
    public TroughItemRenderer() {
        super();
    }
